          ...
          <div className="relative lg:w-1/2 ">
            <div className="w-full lg:w-4/5 lg:ml-auto h-56  sm:h-96">
              <LazyLoad height={762} offset={300}>
                <img
                  className="rounded-xl md:mb-0 sm:pb-96 md:pb-0"
          ...
          <div className="mb-10 lg:max-w-lg lg:mt-32  lg:pr-5 lg:mb-0">
            <div className="max-w-xl mb-6 lg:mt-8 ">
              ...
              <p className="text-base text-gray-100 md:text-lg">
                ...
                dishes. We provide you with daily self-made bread, sourdough
                pizza, roasted fish-meat-vegetables and many more.
              </p>
            </div>
